...
// Get from console
// =================================================
#define AWS_IOT_MQTT_HOST              "aklx72ms36p2f-ats.iot.us-east-1.amazonaws.com" ///< Customer specific MQTT HOST. The same will be used for Thing Shadow
...
#define AWS_IOT_MY_THING_NAME          "MyThing" ///< Thing Name of the Shadow this device is associated with
